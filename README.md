...
- 면 전체를 채우는 진한 남색 타일과 밝은 하늘색 모서리 구분선
- 긴 구덩이 직전 형광 민트색 점프/회피 표시
- 한 면 안에서 왕복하는 빨간 직사각형 장애물
- 살짝 기울어진 정사각형 플레이어 캐릭터
...
- 밝은 하늘색 선: 길 면의 모서리 구분선입니다.
- 형광 민트색 표시: 바로 앞에 긴 구덩이가 있다는 경고입니다.
- 빨간 직사각형 장애물: 한 면 안에서 왕복하는 장애물입니다.
